...
$('#ait-_ait-dir-item-location_type').on('change', function() {
  var value = $(this).val();
	if(value=='Other'){
		$('#ait-_ait-dir-item-location_type_other-option').show();
	}else{
		$('#ait-_ait-dir-item-location_type_other-option').hide();
	}
});

 var others = $("#ait-_ait-dir-item-location_type").val();
	if(others=='Other'){
		$('#ait-_ait-dir-item-location_type_other-option').show();
	}else{
		$('#ait-_ait-dir-item-location_type_other-option').hide();	
