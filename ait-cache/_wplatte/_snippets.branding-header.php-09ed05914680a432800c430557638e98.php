<?php //netteCache[01]000506a:2:{s:4:"time";s:21:"0.91164200 1447148798";s:9:"callbacks";a:3:{i:0;a:3:{i:0;a:2:{i:0;s:6:"NCache";i:1;s:9:"checkFile";}i:1;s:116:"/var/www/vhosts/churchofchristglobal.com/httpdocs/wp-content/themes/directory/Templates/snippets/branding-header.php";i:2;i:1447148705;}i:1;a:3:{i:0;a:2:{i:0;s:6:"NCache";i:1;s:10:"checkConst";}i:1;s:20:"NFramework::REVISION";i:2;s:30:"eee17d5 released on 2011-08-13";}i:2;a:3:{i:0;a:2:{i:0;s:6:"NCache";i:1;s:10:"checkConst";}i:1;s:21:"WPLATTE_CACHE_VERSION";i:2;i:4;}}}?><?php

// source file: /var/www/vhosts/churchofchristglobal.com/httpdocs/wp-content/themes/directory/Templates/snippets/branding-header.php

?><?php list($_l, $_g) = NCoreMacros::initRuntime($template, 'qehms236zy')
;
// snippets support
...
<?php endif ;if (isset($registerMessages)): ?>
...
<?php endif ;if (isset($themeOptions->advertising->showBox1)): ?>
...
<?php if(is_active_sidebar("header-widgets")): dynamic_sidebar('header-widgets'); endif; NCoreMacros::includeTemplate('social-icons.php', $template->getParams(), $_l->templates['qehms236zy'])->render() ;if (!is_admin()): NCoreMacros::includeTemplate('wpml-flags.php', $template->getParams(), $_l->templates['qehms236zy'])->render() ;endif ?>
			</div>
		</div>
<?php endif ?>
</div>
...
<?php endif ;else: if (!empty($themeOptions->general->logo_img)): ?>
			<a class="trademark" href="<?php echo htmlSpecialChars($homeUrl) ?>"><img src="<?php echo WpLatteFunctions::linkTo($themeOptions->general->logo_img) ?>" alt="logo" /></a>
<?php else: ?>
				<a href="<?php echo htmlSpecialChars($homeUrl) ?>"><span><?php echo NTemplateHelpers::escapeHtml($themeOptions->general->logo_text, ENT_NOQUOTES) ?></span></a>
<?php endif ;endif ?>
		</div>
...
<?php wp_nav_menu(array('theme_location' => 'primary-menu', 'fallback_cb' => 'default_menu', 'container' => 'nav', 'container_class' => 'mainmenu', 'menu_class' => 'menu')); else: $screen = get_current_screen() ;$subscriber = in_array('subscriber', $GLOBALS['current_user']->roles) ;if (!$subscriber): ?>
